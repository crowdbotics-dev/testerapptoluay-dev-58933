...
## Project Structure
    ...
    ├── testerapptoluay_dev_58933  # Django project configurations
...
1. Clone this repo and `cd testerapptoluay_dev_58933`
...
2. Clone this repo and `cd testerapptoluay_dev_58933`
